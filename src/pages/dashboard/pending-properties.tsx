  ...
  const fetchPendingProperties = async () => {
    try {
      const response = await axios.get(
        "https://0ca3-175-176-33-143.ngrok-free.app/v1/test/property-fetching/PENDING,UNAVAILABLE", { headers: {
        ...
        <div className={styles.dashboard_container}>
          ...
          <div className={styles.content}>
            <div className={styles.header}>
              <h1 className={styles.h1_header}>Pending Properties</h1>
              ...
              <>
                <div className="mb-5 pb-3 grid grid-cols-8 gap-0 mb-3">
                  ...
                  <div className="col-span-8 border-b-2 border-solid border-gray-300">
                    ...
                    <p className="mb-2">{selectedUser.uploadedby}
                    </p>
                  </div>
